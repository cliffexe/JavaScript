...
console.clear();
class ClassePessoa {
    contructor(firstName, lastName, dob)
 {
...
console.log(pessoa2.getFullYear());
...
const pessoa3 = new PessoaFunc('John', 'Doe', '1980-04-03'); const pessoa4 = new PessoaFunc('Marry', 'Smith', '1970-06-13');

console.log(pessoa3);
console.log(pessoa4.dob.getFullYear());

//Adicionando prototipos
PessoaFunc.prototype.getBirthMonth = function () {
