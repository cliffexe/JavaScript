...
console.log(`A multiplicação de ${valor01} por ${valor02} é ${valor01} * valor 02}`);
...
// Tanabho de strings
console.clear ();
let texto = 'sexosexosexosexosexosexo';
...
// Subistrituir string
console.clear();
let mensagem = 'Pratique sexo';
console.log(mensagem);

let novaMensagem = mensagem.replace('sexo', 'atos carnais');
console.log(novaMensagem);

//Remover Espaços
console.clear();
let text = '       penis pinto rola       ';
